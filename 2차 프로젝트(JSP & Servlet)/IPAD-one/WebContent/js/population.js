...
var fourthInfo = document.getElementById('fourthInfo');

fourthBtn.addEventListener("mouseover", function () {
	fourthInfo.style.display = 'block'
});

fourthBtn.addEventListener("mouseout", function () {
	fourthInfo.style.display = 'none'
});

// --------------------------------
var fifthBtn = document.getElementById('fifthBtn');
var fifthInfo = document.getElementById('fifthInfo');

fifthBtn.addEventListener("mouseover", function () {
	fifthInfo.style.display = 'block'
});

fifthBtn.addEventListener("mouseout", function () {
	fifthInfo.style.display = 'none'
});